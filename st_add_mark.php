        ...
        <div class="container">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group col-lg-12 col-sm-8">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="first" placeholder="المادةالاولى"
                ...
                <div class="form-group col-lg-12 col-sm-8">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="second" placeholder="المادةالثانية"
                ...
                <div class="form-group col-lg-12 col-sm-8">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="third" placeholder="المادةالثالثة"
                ...
                <div class="form-group col-lg-12 col-sm-8">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="fourth" placeholder="المادةالرابعة"
